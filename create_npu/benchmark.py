    ...
    return [
        ...
        },
        {
            ...
            "expected_summary_values": [
                ...
                (("compute_path", "compute_cycles"), 4),
                (("memory_path", "store_cycles"), 6),
                (("top_npu_throughput", "estimated_effective_tops"), 1.204706),
            ],
