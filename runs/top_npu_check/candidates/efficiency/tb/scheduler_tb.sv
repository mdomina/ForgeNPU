module scheduler_tb;
  ...
  initial begin
    ...
    step_and_expect(1'b1, S_DMA_ACT0, 1'b1, 1'b0, 1'b1, 1'b0, 0, 1, 2, 1'b0, 0, 0, 1'b0, 1'b0);
    step_and_expect(1'b0, S_DMA_WGT0, 1'b1, 1'b0, 1'b1, 1'b1, 0, 5, 6, 1'b0, 0, 0, 1'b0, 1'b0);
    step_and_expect(1'b0, S_DMA_ACT1, 1'b1, 1'b0, 1'b1, 1'b0, 1, 3, 4, 1'b0, 0, 0, 1'b0, 1'b0);
    step_and_expect(1'b0, S_DMA_WGT1, 1'b1, 1'b0, 1'b1, 1'b1, 1, 7, 8, 1'b0, 0, 0, 1'b0, 1'b0);
    step_and_expect(1'b0, S_LOAD0, 1'b1, 1'b0, 1'b0, 1'b0, 0, 0, 0, 1'b1, 0, 0, 1'b0, 1'b0);
    step_and_expect(1'b0, S_LOAD1, 1'b1, 1'b0, 1'b0, 1'b0, 0, 0, 0, 1'b1, 1, 1, 1'b0, 1'b0);
    step_and_expect(1'b0, S_COMPUTE0, 1'b1, 1'b0, 1'b0, 1'b0, 0, 0, 0, 1'b0, 0, 0, 1'b1, 1'b0);
    step_and_expect(1'b0, S_COMPUTE1, 1'b1, 1'b0, 1'b0, 1'b0, 0, 0, 0, 1'b0, 0, 0, 1'b1, 1'b0);
