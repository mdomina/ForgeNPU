module top_npu_tb;
  ...
  initial begin
    ...
    step_and_expect(1'b1, S_DMA_ACT, 1'b1, 1'b0, 0, 0, 0, 0, 4'b0000);
    step_and_expect(1'b0, S_DMA_WGT, 1'b1, 1'b0, 0, 0, 0, 0, 4'b0000);
    step_and_expect(1'b0, S_DMA_ACT, 1'b1, 1'b0, 0, 0, 0, 0, 4'b0000);
    step_and_expect(1'b0, S_DMA_WGT, 1'b1, 1'b0, 0, 0, 0, 0, 4'b0000);
    step_and_expect(1'b0, S_LOAD, 1'b1, 1'b0, 0, 0, 0, 0, 4'b0000);
    step_and_expect(1'b0, S_LOAD, 1'b1, 1'b0, 0, 0, 0, 0, 4'b0000);
    step_and_expect(1'b0, S_COMPUTE, 1'b1, 1'b0, 21, 8, 20, 12, 4'b1111);
    step_and_expect(1'b0, S_COMPUTE, 1'b1, 1'b0, 42, 16, 40, 24, 4'b1111);
    ...
    step_and_expect(1'b0, S_DMA_WGT, 1'b1, 1'b0, 0, 0, 0, 0, 4'b0000);
    step_and_expect(1'b0, S_LOAD, 1'b1, 1'b0, 0, 0, 0, 0, 4'b0000);
    step_and_expect(1'b0, S_COMPUTE, 1'b1, 1'b0, 5, 0, 0, 0, 4'b1111);
    step_and_expect(1'b0, S_DONE, 1'b0, 1'b1, 5, 0, 0, 0, 4'b0000);
    step_and_expect(1'b0, S_IDLE, 1'b0, 1'b0, 5, 0, 0, 0, 4'b0000);
