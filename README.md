...
- `candidates/<candidate_id>/execution_report.json`: trace degli stati del `scheduler`, metriche memoria/compute, `dataflow_profile` con `output_stationary/preload/transpose` e stima di throughput del `top_npu`;
