...
- `candidates/<candidate_id>/execution_report.json`: trace degli stati del `scheduler`, metriche memoria/compute, `dataflow_profile` e stima di throughput del `top_npu`;
